...
COPY client/apps/Admin/package.json ./client/apps/Admin/
...
RUN pnpm --filter @client/admin build

# Production - serve with nginx
FROM nginx:alpine
COPY --from=builder /app/client/apps/Admin/dist /usr/share/nginx/html
